...
@Component({
  selector: 'app-plans-hourly',
  templateUrl: './plans-hourly.component.html',
  styleUrls: ['./plans-hourly.component.css']
})
export class PlansHourlyComponent implements OnInit {
  inEditMode = true;
  disableInput = true;
  form: any;
  planId: any;
