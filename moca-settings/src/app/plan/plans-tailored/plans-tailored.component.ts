...
@Component({
  selector: 'app-plans-tailored',
  templateUrl: './plans-tailored.component.html',
  styleUrls: ['./plans-tailored.component.css']
})
export class PlansTailoredComponent implements OnInit {
